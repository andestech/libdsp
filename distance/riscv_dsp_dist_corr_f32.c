...
extern void riscv_dsp_offset_f32(float32_t *src, float32_t offset, float32_t *dst, uint32_t size);
extern float32_t riscv_dsp_mean_f32(const float32_t *src, uint32_t size);
 ...
 *
 */
float32_t riscv_dsp_dist_corr_f32(const float32_t * FUNC_RESTRICT src1, const float32_t * FUNC_RESTRICT src2, uint32_t size)
{
    float32_t mean1 = riscv_dsp_mean_f32(src1, size);
    float32_t mean2 = riscv_dsp_mean_f32(src2, size);
    riscv_dsp_offset_f32((float32_t *)src1, -mean1, (float32_t *)src1, size);
    riscv_dsp_offset_f32((float32_t *)src2, -mean2, (float32_t *)src2, size);
