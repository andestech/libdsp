...
int32_t riscv_dsp_conv_partial_f32(float32_t * FUNC_RESTRICT src1, uint32_t len1,
                                   float32_t * FUNC_RESTRICT src2, uint32_t len2, float32_t * FUNC_RESTRICT dst, uint32_t startindex, uint32_t size)
{
    float32_t *in1 = src1;
    float32_t *in2 = src2;
    float32_t *out = dst;
    float32_t *inx, *iny, *tmpx;
