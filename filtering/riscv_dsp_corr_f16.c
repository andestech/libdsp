...
void riscv_dsp_corr_f16(float16_t * FUNC_RESTRICT src1, uint32_t len1,
                        float16_t * FUNC_RESTRICT src2, uint32_t len2, float16_t * FUNC_RESTRICT dst)
{
    float16_t *pIn1;
    float16_t *pIn2;
    float16_t *pOut = dst;
    float16_t sum;
    float16_t *px;
    float16_t acc0, acc1, acc2, acc3;
    float16_t x0, x1, x2, c0, x3;
    float16_t *py;
    float16_t *pSrc1;
