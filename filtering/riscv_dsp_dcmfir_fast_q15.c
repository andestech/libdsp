...
/**
 * @brief Function for the q15 Decimator FIR filter.
...
void riscv_dsp_dcmfir_fast_q15(const riscv_dsp_dcmfir_q15_t * FUNC_RESTRICT instance, q15_t * FUNC_RESTRICT src, q15_t * FUNC_RESTRICT dst, uint32_t size)
{
