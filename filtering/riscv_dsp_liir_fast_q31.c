                             ...
                             q31_t * FUNC_RESTRICT src, q31_t * FUNC_RESTRICT dst, uint32_t size)
{
    ...
    while (blkcnt != 0u)
    {
        ...
        val_ref = *ref;
        val_lad = *lad;
        fcurr = dsp_truncate_q63_to_q31(((q63_t) fcurr -
                                         ((q31_t) (((q63_t) gcurr * (val_ref)) >> 31))));
        gcurr = dsp_truncate_q63_to_q31(((q63_t) gcurr +
        ...
        *pst = gcurr;
        ...
        while (tapcnt != 0u)
        {
            ...
            ref++;
            gcurr1 = gcurr;
            fcurr1 = dsp_truncate_q63_to_q31(((q63_t) fcurr1 -
                                              ((q31_t) (((q63_t) gcurr * (val_ref)) >> 31))));
            gcurr1 = dsp_truncate_q63_to_q31(((q63_t) gcurr1 +
