 ...
 * types: single-precision floating-point, Q31, Q15 and Q7. These functions are introduced in the
 * subsections below.
 */
...
/**
 * @brief Absolute value of floating-point vectors.
...
/**
 * @brief Absolute value of f64 vectors.
 * @param[in]       *src pointer of the input vector
 * @param[out]      *dst pointer of the output vector.
 * @param[in]       size number of elements in a vector
 * @return none.
 */
void riscv_dsp_abs_f64(float64_t *src, float64_t *dst, uint32_t size);

#if defined (__riscv_zfh)
/**
 * @brief Absolute value of f16 vectors.
 * @param[in]       *src pointer of the input vector
 * @param[out]      *dst pointer of the output vector.
 * @param[in]       size number of elements in a vector
 * @return none.
 */
void riscv_dsp_abs_f16(float16_t *src, float16_t *dst, uint32_t size);
#endif
 ...
 * @image html add.gif ""
 *
 * Andes DSP library supports distinct addition functions for single-precision floating-point, Q31, Q15, Q7 and
...
/**
 * @brief Addition of floating-point vectors.
 ...
 * @return none.
 */
void riscv_dsp_add_f64(float64_t *src1, float64_t *src2, float64_t *dst, uint32_t size);

#if defined (__riscv_zfh)
/**
 * @brief Addition of f16 vectors.
 * @param[in]       *src1 pointer of the first input vector
 * @param[in]       *src2 pointer of the second input vector
 * @param[out]      *dst  pointer of the destination vector
 * @param[in]       size  size of elements in a vector
 * @return none.
 */
void riscv_dsp_add_f16(float16_t *src1, float16_t *src2, float16_t *dst, uint32_t size);
#endif
 ...
 * @image html sub.gif ""
 *
 * Andes DSP library supports distinct subtraction functions for single-precision floating-point, Q31, Q15, Q7 and
 * other data types. These functions are introduced in the subsections below.
 */
/**
...
/**
 * @brief Subtraction of f64 vectors.
 * @param[in]       *src1 pointer of the first input vector
 * @param[in]       *src2 pointer of the second input vector
 * @param[out]      *dst  pointer of the destination vector
 * @param[in]       size  size of elements in a vector
 * @return none.
 */
void riscv_dsp_sub_f64(float64_t *src1, float64_t *src2, float64_t *dst, uint32_t size);

#if defined (__riscv_zfh)
/**
 * @brief Subtraction of f16 vectors.
 * @param[in]       *src1 pointer of the first input vector
 * @param[in]       *src2 pointer of the second input vector
 * @param[out]      *dst  pointer of the destination vector
 * @param[in]       size  size of elements in a vector
 * @return none.
 */
void riscv_dsp_sub_f16(float16_t *src1, float16_t *src2, float16_t *dst, uint32_t size);
#endif
 ...
 * @image html mul.gif ""
 *
 * Andes DSP library supports distinct multiplication functions for single-precision floating-point, Q31, Q15, Q7 and
 * other data types. These functions are introduced in the subsections below.
 */
/**
...
/**
 * @brief Multiplication of f64 vectors.
 * @param[in]       *src1 pointer of the first input vector
 * @param[in]       *src2 pointer of the second input vector
 * @param[out]      *dst  pointer of the destination vector
 * @param[in]       size  size of elements in a vector
 * @return none.
 */
void riscv_dsp_mul_f64(float64_t *src1, float64_t *src2, float64_t *dst, uint32_t size);

#if defined (__riscv_zfh)
/**
 * @brief Multiplication of f16 vectors.
 * @param[in]       *src1 pointer of the first input vector
 * @param[in]       *src2 pointer of the second input vector
 * @param[out]      *dst  pointer of the destination vector
 * @param[in]       size  size of elements in a vector
 * @return none.
 */
void riscv_dsp_mul_f16(float16_t *src1, float16_t *src2, float16_t *dst, uint32_t size);
#endif
 ...
 * @image html div.gif ""
 *
 * Andes DSP library supports distinct division functions for single-precision floating-point, Q31 and other data
...
// Fixed Division
/**
 * @defgroup basic_div_q Fixed Point Division Functions
 * @brief Fixed Point Division Functions
 *
 * Fixed point division functions divide a numerator by a denominator to get a quotient value
which is normalized between -1.0 and 1.0, and a shift left value will also be output to get the
unnormalized quotient.
 *
 * Andes DSP library supports distinct fixed point division functions for Q15 and Q31 data types.
The functions are introduced in the subsections below.
 */
/**
 * @addtogroup basic_div_q
 * @{
 */
/**
 * @brief Fixed point division for q31
 * @param[in]       numerator    numerator value
 * @param[in]       denominator  denominator value
 ...
 * @return -1, when denominator equal to zero.
 */
int riscv_dsp_divide_q31(q31_t numerator,  q31_t denominator,  q31_t *quotient,  int16_t *shift);

/**
 * @brief Fixed point division for q15
 * @param[in]       numerator    numerator value
 * @param[in]       denominator  denominator value
 * @param[out]      quotient     quotient value normalized between -1.0 and 1.0
 * @param[out]      shift        shift left value to get the unnormalized quotient
 ...
 * @image html neg.gif ""
 *
 * Andes DSP library supports distinct negate functions for the following data types: single-precision floating-point,
 ...
 */
/**
 * @brief Negation of floating-point vectors.
 * @param[in]       *src pointer of the input vector
 * @param[out]      *dst pointer of the output vector
 * @param[in]       size number of elements in a vector
 * @return none.
...
/**
 * @brief Negation of f64 vectors.
 * @param[in]       *src pointer of the input vector
 * @param[out]      *dst pointer of the output vector
 * @param[in]       size number of elements in a vector
 * @return none.
 */
void riscv_dsp_neg_f64(float64_t *src, float64_t *dst, uint32_t size);

#if defined (__riscv_zfh)
/**
 * @brief Negation of f16 vectors.
 * @param[in]       *src pointer of the input vector
 * @param[out]      *dst pointer of the output vector
 * @param[in]       size number of elements in a vector
 * @return none.
 */
void riscv_dsp_neg_f16(float16_t *src, float16_t *dst, uint32_t size);
#endif
 ...
 *
 * Andes DSP library supports distinct dot product functions for single-precision floating-point, Q31, Q15, Q7, U8 and
 * other data types. These functions are introduced in the subsections below.
 */
/**
 ...
 */
float32_t riscv_dsp_dprod_f32(float32_t *src1, float32_t *src2, uint32_t size);

/**
 * @brief Dot production of f64 vectors.
 * @param[in]       *src1 pointer of the first input vector
 * @param[in]       *src2 pointer of the second input vector
 * @param[in]       size  number of elements in a vector
 * @return Dot product of the two input vectors
 */
float64_t riscv_dsp_dprod_f64(float64_t *src1, float64_t *src2, uint32_t size);

#if defined (__riscv_zfh)
/**
 * @brief Dot production of f16 vectors.
 * @param[in]       *src1 pointer of the first input vector
 * @param[in]       *src2 pointer of the second input vector
 * @param[in]       size  number of elements in a vector
 * @return Dot product of the two input vectors
 */
float16_t riscv_dsp_dprod_f16(float16_t *src1, float16_t *src2, uint32_t size);
#endif
 ...
 *
 * Andes DSP library supports distinct offset functions for single-precision floating-point, Q31, Q15, Q7 and other
...
/**
 * @brief The offset of f64 vectors.
 * @param[in]       *src pointer of the input vector
 * @param[in]       offset constant offset value
 * @param[out]      *dst pointer of the output vector
 * @param[in]       size number of elements in a vector
 * @return none.
 */
void riscv_dsp_offset_f64(float64_t *src, float64_t offset, float64_t *dst, uint32_t size);

#if defined (__riscv_zfh)
/**
 * @brief The offset of f16 vectors.
 * @param[in]       *src pointer of the input vector
 * @param[in]       offset constant offset value
 * @param[out]      *dst pointer of the output vector
 * @param[in]       size number of elements in a vector
 * @return none.
 */
void riscv_dsp_offset_f16(float16_t *src, float16_t offset, float16_t *dst, uint32_t size);
#endif
 ...
 *
 * Andes DSP library supports distinct scale functions for single-precision floating-point, Q31, Q15, Q7 and U8. These functions are introduced in the subsections below.
 */
/**
...
/**
 * @brief To multiply a f64 vectors by a f64 scale.
 * @param[in]       *src pointer of the input vector
 * @param[in]       scale constant scaling value
 * @param[out]      *dst pointer of the output vector
 * @param[in]       size number of elements in a vector
 * @return none.
 */
void riscv_dsp_scale_f64(float64_t *src, float64_t scale, float64_t *dst, uint32_t size);

#if defined (__riscv_zfh)
/**
 * @brief To multiply a f16 vectors by a f16 scale.
 * @param[in]       *src pointer of the input vector
 * @param[in]       scale constant scaling value
 * @param[out]      *dst pointer of the output vector
 * @param[in]       size number of elements in a vector
 * @return none.
 */
 void riscv_dsp_scale_f16(float16_t *src, float16_t scale, float16_t *dst, uint32_t size);
#endif
 ...
 *
 * Andes DSP library supports distinct shift functions for Q31, Q15, Q7 and U8. These
 ...
 *
 * Andes DSP library supports distinct elementwise clipping functions for single-precision floating-point, Q31, Q15 and Q7 data types. These functions are introduced in the subsections below.
 */
/**
...
#if defined (__riscv_zfh)
/**
 * @brief Elementwise clipping of f16 function.
 * @param[in]       *src pointer of the input vector
 * @param[out]      *dst pointer of the output vector
 * @param[in]       low  lower bound.
 * @param[in]       high higher bound.
 ...
 * @return none.
 */
void riscv_dsp_clip_f16(float16_t *src, float16_t *dst, float16_t low, float16_t high, uint32_t size);
#endif
 ...
 *
 * Andes DSP library supports distinct bitwise AND functions for U32, U16 and U8 data types. These functions are introduced in the subsections below.
 */
/**
 ...
 *
 * Andes DSP library supports distinct bitwise inclusive OR functions for U32, U16 and U8 data types. These functions are introduced in the subsections below.
 */
/**
 * @addtogroup basic_or
 * @{
 ...
 *
 * Andes DSP library supports distinct bitwise XOR functions for U32, U16 and U8 data types. These functions are introduced in the subsections below.
 */
/**
 ...
 *
 * Andes DSP library supports distinct bitwise NOT functions for U32, U16 and U8 data types. These functions are introduced in the subsections below.
 */
/**
...
/**
 * @defgroup basic_absdiff Absolute Difference Functions
 * @brief Absolute Difference Functions
 *
 * Absolute difference functions get absolute diff values from separate source vectors and write them
 * one-by-one into a destination vector.
 *
 * Andes DSP library supports distinct absolute difference functions for the following data
 * types: F32, F16, Q31, Q15 and Q7. These functions are introduced in the subsections below.
 */

/**
 * @addtogroup basic_absdiff
 * @{
 */

/**
 * @brief Absolute differnece value of f32 vectors.
 * @param[in]       *src1 pointer of the first input vector
 * @param[in]       *src2 pointer of the second input vector
 * @param[out]      *dst  pointer of the output vector.
 * @param[in]       size  number of elements in a vector
 * @return none.
 */
void riscv_dsp_absdiff_f32(float32_t *src1, float32_t *src2, float32_t *dst, uint32_t size);

/**
 * @brief Absolute differnece value of f64 vectors.
 * @param[in]       *src1 pointer of the first input vector
 * @param[in]       *src2 pointer of the second input vector
 * @param[out]      *dst  pointer of the output vector.
 * @param[in]       size  number of elements in a vector
 * @return none.
 */
void riscv_dsp_absdiff_f64(float64_t *src1, float64_t *src2, float64_t *dst, uint32_t size);

/**
 * @brief Absolute differnece value of q31 vectors.
 * @param[in]       *src1 pointer of the first input vector
 * @param[in]       *src2 pointer of the second input vector
 * @param[out]      *dst  pointer of the output vector.
 * @param[in]       size  number of elements in a vector
 * @return none.
 */
void riscv_dsp_absdiff_q31(q31_t *src1, q31_t *src2, q31_t *dst, uint32_t size);

/**
 * @brief Absolute differnece value of q15 vectors.
 * @param[in]       *src1 pointer of the first input vector
 * @param[in]       *src2 pointer of the second input vector
 * @param[out]      *dst  pointer of the output vector.
 * @param[in]       size  number of elements in a vector
 * @return none.
 */
void riscv_dsp_absdiff_q15(q15_t *src1, q15_t *src2, q15_t *dst, uint32_t size);

/**
 * @brief Absolute differnece value of q7 vectors.
 * @param[in]       *src1 pointer of the first input vector
 * @param[in]       *src2 pointer of the second input vector
 * @param[out]      *dst  pointer of the output vector.
 * @param[in]       size  number of elements in a vector
 * @return none.
 */
void riscv_dsp_absdiff_q7(q7_t *src1, q7_t *src2, q7_t *dst, uint32_t size);

/**
 * @brief Absolute differnece value of u8 vectors.
 * @param[in]       *src1 pointer of the first input vector
 * @param[in]       *src2 pointer of the second input vector
 * @param[out]      *dst  pointer of the output vector.
 * @param[in]       size  number of elements in a vector
 * @return none.
 */
void riscv_dsp_absdiff_u8(u8_t *src1, u8_t *src2, u8_t *dst, uint32_t size);

#if defined (__riscv_zfh)
/**
 * @brief Absolute differnece value of f16 vectors.
 * @param[in]       *src1 pointer of the first input vector
 * @param[in]       *src2 pointer of the second input vector
 * @param[out]      *dst  pointer of the output vector.
 * @param[in]       size  number of elements in a vector
 * @return none.
 */
void riscv_dsp_absdiff_f16(float16_t *src1, float16_t *src2, float16_t *dst, uint32_t size);
#endif
/** @} basic_absdiff */
