...
/**
 * @brief Conjugate the single-precision floating-point complex vector.
...
/**
 * @brief Conjugate the f16 complex vector.
 * @param[in]		*src pointer of the input complex vector
 * @param[out]		*dst pointer of the output complex vector
 * @param[in]		size number of complex elements in a vector
 * @return none.
 */
void riscv_dsp_cconj_f16(const float16_t *src, float16_t *dst, uint32_t size);
#endif
/**
 ...
 */
/**
 * @brief Compute the dot product of the single-precision floating-point complex vector.
 ...
 * @return none.
 */
void riscv_dsp_cdprod_f16(const float16_t *src1, const float16_t *src2, uint32_t size, float16_t *dst);
#endif
/**
...
/**
 * @brief Compute the dot product type2 of the single-precision floating-point complex vector.
 * @param[in]		*src1 pointer of the first input complex vector
 * @param[in]		*src2 pointer of the second input complex vector
 * @param[in]		size  number of complex elements in a vector
 ...
 * @return none.
 */
void riscv_dsp_cdprod_typ2_f16(const float16_t *src1, const float16_t *src2, uint32_t size, float16_t *rout, float16_t *iout);
#endif
 ...
 */
/**
 * @brief Compute the magnitude of the single-precision floating-point complex vector.
 * @param[in]		*src pointer of the input complex vector
...
/**
 * @brief Compute the magnitude of the f64 complex vector.
 * @param[in]		*src pointer of the input complex vector
 * @param[out]		*dst pointer of the output vector
 * @param[in]		size number of complex elements in a vector
 * @return none.
 */
void riscv_dsp_cmag_f64(const float64_t *src, float64_t *dst, uint32_t size);

#if defined (__riscv_zfh)
/**
 * @brief Compute the magnitude of the f16 complex vector.
 * @param[in]		*src pointer of the input complex vector
 * @param[out]		*dst pointer of the output vector
 * @param[in]		size number of complex elements in a vector
 * @return none.
 */
void riscv_dsp_cmag_f16(const float16_t *src, float16_t *dst, uint32_t size);
#endif
 ...
 * @b Note:
 *
 * The values written into the destination vector is in Q14 format.
 */
...
riscv_dsp_cmag_q15, this function delivers higher precision with slower performance.
 */
void riscv_dsp_cmag_hp_q15(const q15_t *src, q15_t *dst, uint32_t size);
 ...
 * @b Note:
 *
 * The values written into the destination vector is in Q30 format.
 */
 ...
 */
/**
 * @brief Compute the magnitude squared of the single-precision floating-point complex
 *        vector.
 * @param[in]		*src pointer of the input complex vector
 * @param[out]		*dst pointer of the output vector
 * @param[in]		size number of complex elements in a vector
...
/**
 * @brief Compute the magnitude squared of the f64complex vector.
 * @param[in]		*src pointer of the input complex vector
 * @param[out]		*dst pointer of the output vector
 * @param[in]		size number of complex elements in a vector
 * @return none.
 */
void riscv_dsp_cmag_sqr_f64(const float64_t *src, float64_t *dst, uint32_t size);

#if defined (__riscv_zfh)
/**
 * @brief Compute the magnitude squared of the f16 complex vector.
 * @param[in]		*src pointer of the input complex vector
 * @param[out]		*dst pointer of the output vector
 * @param[in]		size number of complex elements in a vector
 * @return none.
 */
void riscv_dsp_cmag_sqr_f16(const float16_t *src, float16_t *dst, uint32_t size);
#endif
 ...
 * types: single-precision floating-point, Q31 and Q15. These functions are introduced in the subsections below.
 */
/**
 * @addtogroup cmul
 * @{
 */
/**
 * @brief Multiply two single-precision floating-point complex vector.
 * @param[in]		*src1 pointer of the first input complex vector
 * @param[in]		*src2 pointer of the second input complex vector
 * @param[out]		*dst  pointer of the output complex vector
 * @param[in]		size  number of complex elements in a vector
...
/**
 * @brief Multiply two f64complex vector.
 * @param[in]		*src1 pointer of the first input complex vector
 * @param[in]		*src2 pointer of the second input complex vector
 * @param[out]		*dst  pointer of the output complex vector
 * @param[in]		size  number of complex elements in a vector
 * @return none.
 */
void riscv_dsp_cmul_f64(const float64_t *src1, const float64_t *src2, float64_t *dst, uint32_t size);

#if defined (__riscv_zfh)
/**
 * @brief Multiply two f16 complex vector.
 * @param[in]		*src1 pointer of the first input complex vector
 * @param[in]		*src2 pointer of the second input complex vector
 * @param[out]		*dst  pointer of the output complex vector
 * @param[in]		size  number of complex elements in a vector
 * @return none.
 */
void riscv_dsp_cmul_f16(const float16_t *src1, const float16_t *src2, float16_t *dst, uint32_t size);
#endif
/**
 ...
 */
/**
 * @brief Multiply the single-precision floating-point complex vector by a real vector.
 * @param[in]		*src  pointer of the input complex vector
...
#if defined (__riscv_zfh)
/**
 * @brief Multiply the f16 complex vector by a real vector.
 * @param[in]		*src  pointer of the input complex vector
 * @param[in]		*real pointer of the input real vector
 * @param[out]		*dst  pointer of the output complex vector
 * @param[in]		size  number of elements in a vector
 * @return none.
 */
void riscv_dsp_cmul_real_f16(const float16_t *src, const float16_t *real, float16_t *dst, uint32_t size);
#endif
/**
