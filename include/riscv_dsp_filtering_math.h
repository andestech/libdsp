 ...
 * data types: single-precision floating-point, Q31, Q15 and Q7. Before you use FIR filter functions, make sure you
 ...
 */
/**
 * @brief Instance structure of the single-precision floating-point FIR filter
 */
typedef struct
{
...
typedef struct
{
    ...
    float64_t *coeff;      /**< pointer of the time reversed coefficient vector whose size
                                is <code>coeff_size</code> in time reversed order. */
} riscv_dsp_fir_f64_t;
...
typedef struct
{
    ...
    float16_t *coeff;      /**< pointer of the time reversed coefficient vector whose size
                                is <code>coeff_size</code> in time reversed order. */
} riscv_dsp_fir_f16_t;
#endif
...
/**
 * @brief Function for the single-precision floating-point FIR filter.
 ...
 *     </pre>
 */
void riscv_dsp_fir_f32(const riscv_dsp_fir_f32_t *instance, float32_t *src, float32_t *dst, uint32_t size);

/**
 * @brief Function for the f64 FIR filter.
 * @param[in]       *instance pointer of the instance structure
 * @param[in]       *src      pointer of the input vector
 * @param[out]      *dst      pointer of the output vector
 * @param[in]       size      number of samples
 * @return none.
 */
void riscv_dsp_fir_f64(const riscv_dsp_fir_f64_t *instance, float64_t *src, float64_t *dst, uint32_t size);

#if defined (__riscv_zfh)
/**
 * @brief Function for the f16 FIR filter.
 * @param[in]       *instance pointer of the instance structure
 * @param[in]       *src      pointer of the input vector
 * @param[out]      *dst      pointer of the output vector
 * @param[in]       size      number of samples
 * @return none.
 */
void riscv_dsp_fir_f16(const riscv_dsp_fir_f16_t *instance, float16_t *src, float16_t *dst, uint32_t size);
#endif
 ...
 * following data types: single-precision floating-point, Q31 and Q15. Before you use lattice FIR filter functions,
...
/**
 * @brief Function for the single-precision floating-point lattice FIR filter.
 * @param[in] instance pointer of the instance structure
 * @param[in] src pointer of the input vector
 * @param[out] dst pointer of the output vector
 * @param[in] size number of samples
 ...
 * the following data types: single-precision floating-point, Q31 and Q15. Before you use decimation FIR filter
 ...
 * the following data types: single-precision floating-point, Q31 and Q15. Before you use upsampling filter functions,
 * make sure you initialize the corresponding instance structure first. These functions and their
 * instance structures are introduced in the subsections below.
 */
/**
 ...
 * following data types: single-precision floating-point, Q31, Q15 and Q7. Before you use sparse FIR filter functions,
 ...
 * for the following data types: single-precision floating-point, Q31 and Q15. Before you use least mean square filter
 * functions, make sure you initialize the corresponding instance structure first. These functions
 * and their instance structures are introduced in the subsections below.
 */
/**
...
/**
 * @brief Function for the single-precision floating-point LMS filter.
 * @param[in] instance pointer of the instance structure
 * @param[in] src pointer of the input vector
 ...
 */
/**
 * @brief Correlation of the single-precision floating-point vectors.
 * @param[in] src1 pointer of the first input vector
 * @param[in] len1 length of the first input vector
 * @param[in] src2 pointer of the second input vector
 * @param[in] len2 length of the second input vector
...
/**
 * @brief Correlation of the f64 vectors.
 * @param[in] src1 pointer of the first input vector
 * @param[in] len1 length of the first input vector
 * @param[in] src2 pointer of the second input vector
 * @param[in] len2 length of the second input vector
 ...
 * @return none.
 */
void riscv_dsp_corr_f64(float64_t *src1, uint32_t len1, float64_t *src2, uint32_t len2, float64_t *dst);

#if defined (__riscv_zfh)
/**
 * @brief Correlation of the f16 vectors.
 * @param[in] src1 pointer of the first input vector
 * @param[in] len1 length of the first input vector
 * @param[in] src2 pointer of the second input vector
 * @param[in] len2 length of the second input vector
 ...
 * @return none.
 */
void riscv_dsp_corr_f16(float16_t *src1, uint32_t len1, float16_t *src2, uint32_t len2, float16_t *dst);
#endif
 ...
 * instance structures for single-precision floating-point, Q31, Q15 and also 32x64 Q31 to meet high precision.
...
/**
 * @brief Instance structure of the single-precision floating-point biquadratic cascade filter.
 */
...
#if defined (__riscv_zfh)
/**
 * @brief Instance structure of the f16 biquadratic cascade filter.
 */

typedef struct
{
    uint32_t nstage;    /**< stages in the filter */
    float16_t *state;   /**< pointer of the state vector whose size is 4*nstage */
    float16_t *coeff;   /**< pointer of the coefficient vector whose size is 5*nstage */
} riscv_dsp_bq_df1_f16_t;
#endif
...
/**
 * @brief single-precision floating-point Biquadratic Cascade Filter (Direct Form I) Functions
 *
 * @param[in] instance pointer of the instance structure
 * @param[in] src pointer of the input vector
 * @param[out] dst pointer of the output vector
...
#if defined (__riscv_zfh)
/**
 * @brief F16 Biquadratic Cascade Filter (Direct Form I) Functions
 *
 * @param[in] instance pointer of the instance structure
 * @param[in] src pointer of the input vector
 * @param[out] dst pointer of the output vector
 ...
 * @return none.
 */
void riscv_dsp_bq_df1_f16(const riscv_dsp_bq_df1_f16_t *instance, float16_t *src, float16_t *dst, uint32_t size);
#endif
 ...
 * functions and instance structures only for single-precision floating-point data types, F32 and F64. Instance
...
#if defined (__riscv_zfh)
/**
 * @brief Structure of the F16 biquadratic cascade filter.
 */
typedef struct
{
    uint32_t nstage;    /**< stages in the filter. */
    float16_t *state;   /**< pointer of the state vector whose size is 2*nstage. */
    float16_t *coeff;   /**< pointer of the coefficient vector whose size is 5*nstage. */
} riscv_dsp_bq_df2T_f16_t;
#endif
...
typedef struct
{
    ...
    float16_t *state;   /**< pointer of the state vector whose size is 4*nstage. */
    float16_t *coeff;   /**< pointer of the coefficient vector whose size is 5*nstage. */
} riscv_dsp_bq_stereo_df2T_f16_t;
#endif
...
/**
 * @brief single-precision floating-point Biquadratic Cascade Filter (Direct Form II) Functions
 *
 * @param[in] instance pointer of the instance structure
 * @param[in] src pointer of the input vector
 * @param[out] dst pointer of the output vector
...
#if defined (__riscv_zfh)
/**
 * @brief F16 Biquadratic Cascade Filter (Direct Form II) Functions
 *
 * @param[in] instance pointer of the instance structure
 * @param[in] src pointer of the input vector
 * @param[out] dst pointer of the output vector
 ...
 * @return none.
 */
void riscv_dsp_bq_df2T_f16(const riscv_dsp_bq_df2T_f16_t *instance, float16_t *src, float16_t *dst, uint32_t size);
#endif
 ...
 * @return none.
 */
void riscv_dsp_bq_stereo_df2T_f16(const riscv_dsp_bq_stereo_df2T_f16_t *instance, float16_t *src, float16_t *dst, uint32_t size);
#endif
/** @} bq_df2 */
 ...
 * following data types: single-precision floating-point, Q31 and Q15. Before you use lattice IIR filter functions,
 * make sure you initialize the corresponding instance structure first. These functions and their
 * instance structures are introduced in the subsections below.
 */
...
// Levinson Durbi functions
/**
 * @defgroup levin_durbin Levinson-Durbin Functions
 *
 * @brief  Levinson-Durbin Functions
 *
 * Levinson-Durbin functions are used to calculate the coefficients of an autoregressive linear process.
 *
 * Andes DSP library supports distinct Levinson-Durbin functions for the following data types: single- and half-precision floating-point and Q31. These functions are introduced in the subsections below.
 */

/**
 * @addtogroup levin_durbin
 * @{
 */
/**
 * @brief         Levinson Durbin of F32
 * @param[in]     src      pointer of the input autocovariance vector starting with lag 0 and having a size of coeff_size + 1
 * @param[out]    coeff    pointer of the output autoregressive coefficient vector whose size is coeff_size
 * @param[out]    err      pointer of the output prediction error
 * @param[in]     coeff_size   number of autoregressive coefficients
 * @return        none
 */
void riscv_dsp_levinson_durbin_f32(const float32_t * src, float32_t * coeff, float32_t * err, uint32_t coeff_size);

#if defined (__riscv_zfh)
/**
 * @brief         Levinson Durbin of F16
 * @param[in]     src      pointer of the input autocovariance vector starting with lag 0 and having a size of coeff_size + 1
 * @param[out]    coeff    pointer of the output autoregressive coefficient vector whose size is coeff_size
 * @param[out]    err      pointer of the output prediction error
 * @param[in]     coeff_size   number of autoregressive coefficients
 * @return        none
 */
void riscv_dsp_levinson_durbin_f16(const float16_t * src, float16_t * coeff, float16_t * err, uint32_t coeff_size);
#endif

/**
 * @brief         Levinson Durbin of Q31
 * @param[in]     src      pointer of the input autocovariance vector starting with lag 0 and having a size of coeff_size + 1
 * @param[out]    coeff    pointer of the output autoregressive coefficient vector whose size is coeff_size
 * @param[out]    err      pointer of the output prediction error
 * @param[in]     coeff_size   number of autoregressive coefficients
 * @return        none
 */
void riscv_dsp_levinson_durbin_q31(const q31_t * src, q31_t * coeff, q31_t * err, uint32_t coeff_size);
/** @} levin_durbin */
/** @} filter */
