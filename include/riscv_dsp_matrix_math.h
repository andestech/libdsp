 ...
 *
 * Andes DSP library supports distinct matrix addition functions for the following data types: single- and double-precision floating-point, Q31 and Q15. These functions are introduced in the subsections below.
 */
/**
 * @addtogroup mat_add
 * @{
 */
/**
 * @brief Addition of two single-precision floating-point matrices.
...
/**
 * @brief Addition of two f16 matrices.
 * @param[in] src1 pointer of the first input matrix
 * @param[in] src2 pointer of the second input matrix
 * @param[out] dst pointer of the output matrix
 * @param[in] row number of rows in a matrix
 ...
 * @return none.
 */
void riscv_dsp_mat_add_f16(const float16_t *src1, const float16_t *src2, float16_t *dst, uint32_t row, uint32_t col);
#endif

/**
 * @brief Addition of two double-precision floating-point matrices.
 * @param[in] src1 pointer of the first input matrix
 * @param[in] src2 pointer of the second input matrix
 * @param[out] dst pointer of the output matrix
 * @param[in] row number of rows in a matrix
 ...
 *
 * Andes DSP library supports distinct matrix inverse functions for the following data types: single- and
...
/**
 * @brief Compute the inverse matrix of the f64 matrix.
 * @param[in]       *src pointer of the input matrix
 * @param[out]      *dst  pointer of the output matrix
 * @param[in]       size  number of rows/columns in a matrix (i.e. size = rows = columns)
 * @return (0 success; -1 failure)
...
#if defined (__riscv_zfh)
/**
 * @brief Compute the inverse matrix of the f16 matrix.
 * @param[in]       *src pointer of the input matrix
 * @param[out]      *dst  pointer of the output matrix
 * @param[in]       size  number of rows/columns in a matrix (i.e. size = rows = columns)
 * @return (0 success; -1 failure)
 */
int32_t riscv_dsp_mat_inv_f16(float16_t *src, float16_t *dst, uint32_t size);
#endif
...
#if defined (__riscv_zfh)
/**
 * @brief Multiplication of two f16 matrices.
 * @param[in] src1 pointer of the first input matrix
 * @param[in] src2 pointer of the second input matrix
 * @param[out] dst pointer of the output matrix
 * @param[in] row number of rows in the first input matrix
 ...
 * @return none.
 */
void riscv_dsp_mat_mul_f16(const float16_t *src1, const float16_t *src2, float16_t *dst, uint32_t row, uint32_t col, uint32_t col2);
#endif
 ...
 * single-precision floating-point, Q31, and Q15. These functions are introduced in the subsections below.
 */
/**
 ...
 */
/**
 * @brief Multiplt a scale value of floating-point matrix.
 * @param[in]       *src pointer of the input matrix
...
/**
 * @brief Multiplt a scale value of f64 matrix.
 * @param[in]       *src pointer of the input matrix
 * @param[in]       scale constant scaling value
 * @param[out]      *dst  pointer of the output matrix
 * @param[in]       row   number of rows in a matrix
 ...
 * @return none.
 */
void riscv_dsp_mat_scale_f64(const float64_t *src, float64_t scale, float64_t *dst, uint32_t row, uint32_t col);

#if defined (__riscv_zfh)
/**
 * @brief Multiplt a scale value of f16 matrix.
 * @param[in]       *src pointer of the input matrix
 * @param[in]       scale constant scaling value
 * @param[out]      *dst  pointer of the output matrix
 * @param[in]       row   number of rows in a matrix
 ...
 * @return none.
 */
void riscv_dsp_mat_scale_f16(const float16_t *src, float16_t scale, float16_t *dst, uint32_t row, uint32_t col);
#endif
 ...
 *
 * Andes DSP library supports distinct matrix subtraction functions for the following data types: single- and double-precision floating-point, Q31 and Q15. These functions are introduced in the subsections below.
 */
/**
 * @addtogroup mat_sub
 * @{
 */
/**
 * @brief Substraction of two single-precision floating-point matrices.
 * @param[in] src1 pointer of the first input matrix
 * @param[in] src2 pointer of the second input matrix
 * @param[out] dst pointer of the output matrix
 * @param[in] row number of rows in a matrix
...
/**
 * @brief Substraction of two double-precision floating-point matrices.
 * @param[in] src1 pointer of the first input matrix
 * @param[in] src2 pointer of the second input matrix
 * @param[out] dst pointer of the output matrix
 * @param[in] row number of rows in a matrix
...
#if defined (__riscv_zfh)
/**
 * @brief Substraction of two f16 matrices.
 * @param[in] src1 pointer of the first input matrix
 * @param[in] src2 pointer of the second input matrix
 * @param[out] dst pointer of the output matrix
 * @param[in] row number of rows in a matrix
 ...
 * @return none.
 */
void riscv_dsp_mat_sub_f16(const float16_t *src1, const float16_t *src2, float16_t *dst, uint32_t row, uint32_t col);
#endif
 ...
 *
 * Andes DSP library supports distinct matrix transpose functions for single- and double-precision floating-point, Q31, Q15, Q7 and U8. These functions are introduced in the subsections below.
 */
/**
 ...
 */
/**
 * @brief Transpose the single-precision floating-point matrices.
 * @param[in]       src  pointer of the input matrix
 * @param[out]      dst  pointer of the output matrix
 * @param[in]       row   number of rows in a matrix
 * @param[in]       col   number of columns in a matrix
...
/**
 * @brief Transpose the double-precision floating-point matrices.
 * @param[in]       src  pointer of the input matrix
 * @param[out]      dst  pointer of the output matrix
 * @param[in]       row   number of rows in a matrix
 * @param[in]       col   number of columns in a matrix
...
#if defined (__riscv_zfh)
/**
 * @brief Transpose the f16 matrices.
 * @param[in]       src  pointer of the input matrix
 * @param[out]      dst  pointer of the output matrix
 * @param[in]       row   number of rows in a matrix
 * @param[in]       col   number of columns in a matrix
 * @return none.
 */
void riscv_dsp_mat_trans_f16(const float16_t *src, float16_t *dst, uint32_t row, uint32_t col);
#endif
...
/**
 * @defgroup cmat_trans Complex Matrix Transpose Functions
 * @brief Complex Matrix Transpose Functions
 *
 * Complex matrix transpose functions transpose a complex matrix and write the result into a
destination complex matrix.
 *
 * Andes DSP library supports distinct complex matrix transpose functions for the following data
types: single-precision floating-point, Q31 and Q15. These functions are introduced in the
subsections below.
 */
/**
 * @addtogroup cmat_trans
 * @{
 */
/**
 * @brief Transpose the single-precision floating-point complex matrices.
 ...
 * @return none.
 */
void riscv_dsp_cmat_trans_f32(const float32_t *src, float32_t *dst, uint32_t row, uint32_t col);

#if defined (__riscv_zfh)
/**
 * @brief Transpose the f16  complex matrices.
 * @param[in]       src  pointer of the input complex matrix
 * @param[out]      dst  pointer of the output complex matrix
 * @param[in]       row   number of rows in a complex matrix
 * @param[in]       col   number of columns in a complex matrix
 * @return none.
 */
void riscv_dsp_cmat_trans_f16(const float16_t *src, float16_t *dst, uint32_t row, uint32_t col);
#endif

/**
 * @brief Transpose the q15 complex matrices.
 * @param[in]       src  pointer of the input complex matrix
 * @param[out]      dst  pointer of the output complex matrix
 * @param[in]       row   number of rows in a complex matrix
 * @param[in]       col   number of columns in a complex matrix
 * @return none.
 */
void riscv_dsp_cmat_trans_q15(const q15_t *src, q15_t *dst, uint32_t row, uint32_t col);

/**
 * @brief Transpose the q31 complex matrices.
 * @param[in]       src  pointer of the input complex matrix
 * @param[out]      dst  pointer of the output complex matrix
 * @param[in]       row   number of rows in a complex matrix
 * @param[in]       col   number of columns in a complex matrix
 * @return none.
 */
void riscv_dsp_cmat_trans_q31(const q31_t *src, q31_t *dst, uint32_t row, uint32_t col);
 ...
 * data types: single-precision floating-point, Q31, and Q15. These functions are introduced in the subsections
 * below.
 */
/**
 * @addtogroup cmat_mul
...
#if defined (__riscv_zfh)
/**
 * @brief Multiplication of two f16 complex matrices.
 * @param[in]   src1 pointer of the first input complex matrix
 * @param[in]   src2 pointer of the second input complex matrix
 * @param[out]  dst  pointer of the output complex matrix
 * @param[in]   row  number of rows in the first complex matrix
 ...
 * @return none.
 */
void riscv_dsp_cmat_mul_f16(const float16_t *src1, const float16_t *src2, float16_t *dst, uint32_t row, uint32_t col, uint32_t col2);
#endif
...
#if defined (__riscv_zfh)
/**
 * @brief Matrix multiply vector for f16 formats
 * @param[in]   src1 pointer of the input matrix
 * @param[in]   src2 pointer of the input vector
 * @param[out]  dst  pointer of the output vector
 * @param[in]   row  number of rows in the matrix
 ...
 * @return none.
 */
void riscv_dsp_mat_mul_mxv_f16(const float16_t *src1, const float16_t *src2, float16_t *dst, uint32_t row, uint32_t col);
#endif
...
/**
 * @defgroup mat_chd Matrix Matrix Cholesky Decomposition Function
 * @brief Matrix Cholesky Decomposition Function
 *
 * Matrix Cholesky decomposition functions perform the Cholesky decomposition of an input matrix and then write the results into a destination matrix. They will return -1 if the decomposition fails.
 *
 * The Cholesky decomposition of a matrix A is a decomposition in the form
 *  A=LL^T
 * where L is the destination matrix and a real lower triangular matrix with positive diagonal entries.
 *
 * Andes DSP library supports distinct matrix Cholesky decomposition functions for the following data types: single-, half- and double-precision floating-point. These functions are introduced in the subsections below.
 */
/**
 * @addtogroup mat_chd
 * @{
...
/**
 * @brief Matrix Cholesky Decomposition Function of f32 data types
 * @param[in]   *src pointer of the input matrix
 * @param[out]  *dst  pointer of the output matrix
 * @param[in]   row  number of rows in a matrix
 * @param[in]   col  number of columns in a matrix
 * @return none.
 */
int riscv_dsp_mat_cholesky_f32(float32_t* src, float32_t* dst, uint32_t row, uint32_t col);
/**
 * @brief Matrix Cholesky Decomposition Function of f64 data types
 * @param[in]   *src pointer of the input matrix
 * @param[out]  *dst  pointer of the output matrix
 * @param[in]   row  number of rows in a matrix
 * @param[in]   col  number of columns in a matrix
 * @return none.
 */
int riscv_dsp_mat_cholesky_f64(float64_t* src, float64_t* dst, uint32_t row, uint32_t col);
#if defined (__riscv_zfh)
/**
 * @brief Matrix Cholesky Decomposition Function of f16 data types
 * @param[in]   *src pointer of the input matrix
 * @param[out]  *dst  pointer of the output matrix
 * @param[in]   row  number of rows in a matrix
 * @param[in]   col  number of columns in a matrix
 * @return none.
 */
int riscv_dsp_mat_cholesky_f16(float16_t* src, float16_t* dst, uint32_t row, uint32_t col);
#endif
/** @} mat_chd */

/**
 * @defgroup mat_ldlt Matrix LDLT Decomposition Functions
 * @brief Matrix LDLT Decomposition Functions
 *
 * Matrix LDLT decomposition functions perform the LDLT decomposition of an input matrix and then write the results into destination matrices. They will return -1 if the decomposition fails.
The LDLT decomposition of a matrix A is a decomposition in the form PAP^T = LDL^T
...
Andes DSP library supports distinct matrix LDLT decomposition functions for the following data types: single- and double-precision floating-point. These functions are introduced in the subsections below.
 *
 */
/**
 * @addtogroup mat_ldlt
 ...
 */
/**
 * @brief Matrix LDLT decomposition function for F32.
 * @param[in]   *src   pointer of the input matrix
 * @param[out]  *dstl  pointer of the output lower triangular matrix
 * @param[out]  *dstd  pointer of the output diagonal matrix
 * @param[out]  *pp  pointer of the output permutation vector
 * @param[in]   row  number of rows in a matrix
 * @param[in]   col  number of columns in a matrix
 * @return 0 if the decomposition succeeds.
 *         -1 if the decomposition fails.
 */
int riscv_dsp_mat_ldlt_f32(float32_t* src, float32_t* dstl, float32_t* dstd,  uint16_t* pp, uint32_t row, uint32_t col);
/**
 * @brief Matrix LDLT decomposition function for F64.
 * @param[in]   *src   pointer of the input matrix
 * @param[out]  *dstl  pointer of the output lower triangular matrix
 * @param[out]  *dstd  pointer of the output diagonal matrix
 * @param[out]  *pp  pointer of the output permutation vector
 ...
 *         -1 if the decomposition fails.
 */
int riscv_dsp_mat_ldlt_f64(float64_t* src, float64_t* dstl, float64_t* dstd,  uint16_t* pp, uint32_t row, uint32_t col);
/** @} mat_ldlt */

/**
 * @defgroup mat_solve_lt Matrix Solve Lower Triangular Functions
 * @brief Matrix Solve Lower Triangular Functions
 *
 * Matrix solve lower triangular functions solve the lower triangle decomposition for an input matrix and write the results into a destination matrix.
The lower triangle decomposition is solved in the following form. Lx = A
That is, the destination matrix x can be obtained if given the input matrix A and the lower triangular matrix L.
Andes DSP library supports distinct matrix solve lower triangular functions for the following data types: single-, half- and double-precision floating-point. These functions are introduced in the subsections below.
 */
/**
 * @addtogroup mat_solve_lt
 * @{
 */
/**
 * @brief Matrix solve lower triangular function for F32.
 * @param[in]   *lt   pointer of the input lower triangular matrix
 * @param[in]  *A  pointer of the input matrix
 * @param[out]  *dst  pointer of the output matrix
 * @param[in]   row  number of rows in a matrix
 * @param[in]   col  number of columns in a matrix
 * @return 0 if the decomposition is solved.
 *         -1 if the decomposition is not solved.
 */
int riscv_dsp_mat_solve_lt_f32(float32_t* lt, float32_t* A, float32_t* dst, uint32_t row, uint32_t col);
/**
 * @brief Matrix solve lower triangular function for F64.
 * @param[in]   *lt   pointer of the input lower triangular matrix
 * @param[in]  *A  pointer of the input matrix
 * @param[out]  *dst  pointer of the output matrix
 * @param[in]   row  number of rows in a matrix
 ...
 *         -1 if the decomposition is not solved.
 */
int riscv_dsp_mat_solve_lt_f64(float64_t* lt, float64_t* A, float64_t* dst, uint32_t row, uint32_t col);
#if defined (__riscv_zfh)
/**
 * @brief Matrix solve lower triangular function for F16.
 * @param[in]   *lt   pointer of the input lower triangular matrix
 * @param[in]  *A  pointer of the input matrix
 * @param[out]  *dst  pointer of the output matrix
 * @param[in]   row  number of rows in a matrix
 ...
 *         -1 if the decomposition is not solved.
 */
int riscv_dsp_mat_solve_lt_f16(float16_t* lt, float16_t* A, float16_t* dst, uint32_t row, uint32_t col);
#endif
/** @} mat_solve_lt */

/**
 * @defgroup mat_solve_ut Matrix Solve Upper Triangular Functions
 * @brief Matrix Solve Upper Triangular Functions
 *
 * Matrix solve upper triangular functions solve the upper triangle decomposition for an input matrix and write the results into a destination matrix.
The upper triangle decomposition is solved in the following form. Ux = A
That is, the destination matrix x can be obtained if given the input matrix A and the upper triangular matrix U.
Andes DSP library supports distinct functions for the following data types: single-, half- and double-precision floating-point. These functions are introduced in the subsections below.
 */
/**
 * @addtogroup mat_solve_ut
 * @{
 */
/**
 * @brief Matrix solve upper triangular function for F32.
 ...
 *         -1 if the decomposition is not solved.
 */
int riscv_dsp_mat_solve_ut_f32(float32_t* ut, float32_t* A, float32_t* dst, uint32_t row, uint32_t col);
/**
 * @brief Matrix solve upper triangular function for F64.
 * @param[in]   *ut   pointer of the input upper triangular matrix
 * @param[in]  *A  pointer of the input matrix
 * @param[out]  *dst  pointer of the output matrix
 * @param[in]   row  number of rows in a matrix
 ...
 *         -1 if the decomposition is not solved.
 */
int riscv_dsp_mat_solve_ut_f64(float64_t* ut, float64_t* A, float64_t* dst, uint32_t row, uint32_t col);
#if defined (__riscv_zfh)
/**
 * @brief Matrix solve upper triangular function for F16.
 * @param[in]   *ut   pointer of the input upper triangular matrix
 * @param[in]  *A  pointer of the input matrix
 * @param[out]  *dst  pointer of the output matrix
 * @param[in]   row  number of rows in a matrix
 ...
 *         -1 if the decomposition is not solved.
 */
int riscv_dsp_mat_solve_ut_f16(float16_t* ut, float16_t* A, float16_t* dst, uint32_t row, uint32_t col);
#endif
/** @} mat_solve_ut */

/**
 * @defgroup mat_house Matrix Householder Transform Functions
 * @brief Matrix Householder Transform Functions
 *
 * Andes DSP library supports distinct functions for the following data types: single-, half- and double-precision floating-point. These functions are introduced in the subsections below.
 */
/**
 * @addtogroup mat_house
 * @{
 */
/**
 * @brief         Matrix Householder transform function for F32.
 * @param[in]     src        pointer of the input vector
 * @param[in]     threshold   norm2 threshold.
 * @param[in]     size   number of size in a vector
 * @param[out]    dst    pointer of the output vector
 */
float32_t riscv_dsp_mat_householder_f32(const float32_t * src, const float32_t threshold, uint32_t size, float32_t * dst);
/**
 * @brief         Matrix Householder transform function for F64.
 * @param[in]     src        pointer of the input vector
 * @param[in]     threshold   norm2 threshold.
 * @param[in]     size   number of size in a vector
 * @param[out]    dst    pointer of the output vector
 */
float64_t riscv_dsp_mat_householder_f64(const float64_t * src, const float64_t threshold, uint32_t size, float64_t * dst);
#if defined (__riscv_zfh)
/**
 * @brief         Matrix Householder transform function for F16.
 * @param[in]     src        pointer of the input vector
 * @param[in]     threshold   norm2 threshold.
 * @param[in]     size   number of size in a vector
 * @param[out]    dst    pointer of the output vector
 */
float16_t riscv_dsp_mat_householder_f16(const float16_t * src, const float16_t threshold, uint32_t size, float16_t * dst);
#endif
/** @} mat_house */

/**
 * @defgroup mat_qr Matrix QR Decomposition Functions
 * @brief Matrix QR Decomposition Functions
 *
 * Matrix QR decomposition functions perform the QR decomposition of a matrix M using the Householder algorithm, M = QR, where Q is an orthogonal matrix and R is an upper triangular.
 *
 * Andes DSP library supports distinct matrix QR decomposition functions for the following data types: single-, half- and double-precision floating-point. These functions are introduced in the subsections below.
 */
/**
 * @addtogroup mat_qr
 * @{
 */
/**
 * @brief         Matrix QR decomposition function for F32
 * @param[in]     src        pointer of the input matrix whose size is row*col
 * @param[in]     threshold   norm2 threshold.
 * @param[out]    dstR    pointer of the output matrix R whose size is row*col
 * @param[out]    dstQ    pointer of the output matrix Q whose size is row*row or a NULL pointer
 * @param[out]     tau    pointer of the Householder scaling factor whose size is col
 * @param[in]    pTmpA     pointer of the temporary vector whose size is row
 * @param[in]    pTmpB     pointer of the temporary vector whose size is row
 * @param[in]   row  number of rows in a matrix
 * @param[in]   col  number of columns in a matrix
 * @return 0 if the decomposition is solved.
 *         -1 if the decomposition is not solved.
 */
int riscv_dsp_mat_qr_f32(const float32_t * src, const float32_t threshold, float32_t * dstR, float32_t * dstQ, float32_t * tau,
                         float32_t * pTmpA, float32_t * pTmpB, const uint32_t row, const uint32_t col);
/**
 * @brief         Matrix QR decomposition function for F64
 * @param[in]     src        pointer of the input matrix whose size is row*col
 * @param[in]     threshold   norm2 threshold.
 * @param[out]    dstR    pointer of the output matrix R whose size is row*col
 * @param[out]    dstQ    pointer of the output matrix Q whose size is row*row or a NULL pointer
 ...
 *         -1 if the decomposition is not solved.
 */
int riscv_dsp_mat_qr_f64(const float64_t * src, const float64_t threshold, float64_t * dstR, float64_t * dstQ, float64_t * tau,
                         float64_t * pTmpA, float64_t * pTmpB, const uint32_t row, const uint32_t col);
#if defined (__riscv_zfh)
/**
 * @brief         Matrix QR decomposition function for F16
 * @param[in]     src        pointer of the input matrix whose size is row*col
 * @param[in]     threshold   norm2 threshold.
 * @param[out]    dstR    pointer of the output matrix R whose size is row*col
 * @param[out]    dstQ    pointer of the output matrix Q whose size is row*row or a NULL pointer
 ...
 *         -1 if the decomposition is not solved.
 */
int riscv_dsp_mat_qr_f16(const float16_t * src, const float16_t threshold, float16_t * dstR, float16_t * dstQ, float16_t * tau,
                         float16_t * pTmpA, float16_t * pTmpB, const uint32_t row, const uint32_t col);
#endif
/** @} mat_qr */
