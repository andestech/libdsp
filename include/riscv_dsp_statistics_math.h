 ...
 */
/**
 * @brief Maximum value of the floating-point vector.
 ...
 */
/**
 * @brief Minimum value of the floating-point vector.
 * @param[in]       src     pointer of the input vector
 * @param[in]       size    number of elements in a vector
 * @param[out]      index   index of the maximum value
 ...
 */
/**
 * @brief Maximum absolute value of the floating-point vector.
 * @param[in]       src     pointer of the input vector
 * @param[in]       size    number of elements in a vector
 * @param[out]      index   index of the maximum value
 ...
 */
/**
 * @brief Minimum absolute value of the floating-point vector.
 * @param[in]       src     pointer of the input vector
 * @param[in]       size    number of elements in a vector
 * @param[out]      index   index of the maximum value
 * @return Minimum value
