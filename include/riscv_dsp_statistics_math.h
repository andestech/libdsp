...
/**
 * @brief Maximum value of the f16 vector.
 * @param[in]       src     pointer of the input vector
 * @param[in]       size    number of elements in a vector
 * @param[out]      index   index of the maximum value
 * @return Maximum value
 */
float16_t riscv_dsp_max_f16(const float16_t *src, uint32_t size, uint32_t *index);
#endif
...
#if defined (__riscv_zfh)
/**
 * @brief Maximum value of the sf16 vector.
 * @param[in]       src     pointer of the input vector
 * @param[in]       size    number of elements in a vector
 * @return Maximum value
 */
float16_t riscv_dsp_max_val_f16(const float16_t *src, uint32_t size);
#endif
...
#if defined (__riscv_zfh)
/**
 * @brief Minimum value of the f16 vector.
 * @param[in]       src     pointer of the input vector
 * @param[in]       size    number of elements in a vector
 * @param[out]      index   index of the minimum value
 * @return Minimum value
 */
float16_t riscv_dsp_min_f16(const float16_t *src, uint32_t size, uint32_t *index);
#endif
 ...
 * @return Maximum value
 */
float16_t riscv_dsp_min_val_f16(const float16_t *src, uint32_t size);
#endif
...
/**
 * @brief Mean value of the f64 vector.
 * @param[in]       src    pointer of the input vector
 * @param[in]       size   number of elements in a vector
 * @return Mean value.
 */
float64_t riscv_dsp_mean_f64(const float64_t *src, uint32_t size);

#if defined (__riscv_zfh)
/**
 * @brief Mean value of the f16 vector.
 * @param[in]       src    pointer of the input vector
 * @param[in]       size   number of elements in a vector
 * @return Mean value.
 */
...
#if defined (__riscv_zfh)
/**
 * @brief Sum of the squares of the f16 vector.
 * @param[in]       src    pointer of the input vector
 * @param[in]       size   number of elements in a vector
 * @return Sum of squares
 */
float16_t riscv_dsp_pwr_f16(const float16_t *src, uint32_t size);
#endif

/**
 * @brief Sum of the squares of the f64 vector.
 * @param[in]       src    pointer of the input vector
 * @param[in]       size   number of elements in a vector
 * @return Sum of squares
 */
float64_t riscv_dsp_pwr_f64(const float64_t *src, uint32_t size);
...
#if defined (__riscv_zfh)
/**
 * @brief Standard deviation of the f16 vector.
 * @param[in]       src    pointer of the input vector
 * @param[in]       size   number of elements in a vector
 * @return Standard deviation value.
 */
float16_t riscv_dsp_std_f16(const float16_t *src, uint32_t size);
#endif

/**
 * @brief Standard deviation of the f64 vector.
 * @param[in]       src    pointer of the input vector
 * @param[in]       size   number of elements in a vector
 * @return Standard deviation value.
 */
...
#if defined (__riscv_zfh)
/**
 * @brief Variance of the f16 vector.
 * @param[in]       src    pointer of the input vector
 * @param[in]       size   number of elements in a vector
 * @return Variance value.
 */
float16_t riscv_dsp_var_f16(const float16_t *src, uint32_t size);
#endif

/**
 * @brief Variance of the f64 vector.
 * @param[in]       src    pointer of the input vector
 * @param[in]       size   number of elements in a vector
 * @return Variance value.
 */
...
/**
 * @brief Entropy of the f64 vector.
 * @param[in]       src    pointer of the input vector
 * @param[in]       size   number of elements in a vector
 * @return Entropy value.
 */
float64_t riscv_dsp_entropy_f64(const float64_t * src, uint32_t size);

#if defined (__riscv_zfh)
/**
 * @brief Entropy of the f16 vector.
 * @param[in]       src    pointer of the input vector
 * @param[in]       size   number of elements in a vector
 * @return Entropy value.
 */
float16_t riscv_dsp_entropy_f16(const float16_t * src, uint32_t size);
#endif
/** @} entropy */
...
/**
 * @brief Relative Entropy of the f64 vector.
 * @param[in]       src1    pointer of the first input vector
 * @param[in]       src2    pointer of the second input vector
 * @param[in]       size   size of elements in a vector
 * @return Relative Entropy value.
 */
float64_t riscv_dsp_relative_entropy_f64(const float64_t * src1, const float64_t * src2, uint32_t size);

#if defined (__riscv_zfh)
/**
 * @brief Relative Entropy of the f16 vector.
 * @param[in]       src1    pointer of the first input vector
 * @param[in]       src2    pointer of the second input vector
 * @param[in]       size   size of elements in a vector
 * @return Relative Entropy value.
 */
float16_t riscv_dsp_relative_entropy_f16(const float16_t * src1, const float16_t * src2, uint32_t size);
#endif
/** @} rel_entropy */
...
#if defined (__riscv_zfh)
/**
 * @brief Log-Sum-Exp of the f16 vector.
 * @param[in]       src    pointer of the input vector
 * @param[in]       size   number of elements in a vector
 * @return LSE value.
 */
float16_t riscv_dsp_lse_f16(const float16_t * src, uint32_t size);
#endif
/** @} lse */
...
#if defined (__riscv_zfh)
/**
 * @brief Dot product with Log-Sum-Exp of the f16 vector.
 * @param[in]       src1    pointer of the first input vector
 * @param[in]       src2    pointer of the second input vector
 * @param[in]       size    size of elements in a vector
 * @param[in]       buffer  pointer of the temporary vector
 * @return LSE dot product value
 */
float16_t riscv_dsp_lse_dprod_f16(const float16_t *src1, const float16_t *src2, uint32_t size, float16_t *buffer);
#endif
/** @} lse_dprod */
...
} riscv_dsp_gaussian_naivebayes_f16_t;
#endif
/**
...
#if defined (__riscv_zfh)
/**
 * @brief Maximum absolute value of the f16 vector.
 * @param[in]       src     pointer of the input vector
 * @param[in]       size    number of elements in a vector
 * @param[out]      index   index of the maximum value
 * @return Absolute maximum value
 */
float16_t riscv_dsp_absmax_f16(const float16_t* src, uint32_t size, uint32_t* index);
#endif

/**
 * @brief Maximum absolute value of the f32 vector.
 * @param[in]       src     pointer of the input vector
 * @param[in]       size    number of elements in a vector
 * @return Absolute maximum value
 */
 ...
 * @return Absolute maximum value
 */
float16_t riscv_dsp_absmax_val_f16(const float16_t* src, uint32_t size);
#endif
...
#if defined (__riscv_zfh)
/**
 * @brief Minimum absolute value of the f16 vector.
 * @param[in]       src     pointer of the input vector
 * @param[in]       size    number of elements in a vector
 * @param[out]      index   index of the minimum value
 * @return Minimum value
 */
float16_t riscv_dsp_absmin_f16(const float16_t* src, uint32_t size, uint32_t* index);
#endif
 ...
 * @return Minimum value
 */
float16_t riscv_dsp_absmin_val_f16(const float16_t* src, uint32_t size);
#endif
 ...
 * @param[out]    result    pointer of the result
 */
void riscv_dsp_mse_f16(const float16_t * src1, const float16_t * src2, uint32_t size, float16_t * result);
#endif
/**
 ...
 *
 * Andes DSP library supports distinct accumulation functions for single-, half- and double-precision floating-point,
 ...
 * @return Accumulate value
 */
float64_t riscv_dsp_accum_f64(const float64_t * src, uint32_t size);
 ...
 * @return Accumulate value
 */
q63_t riscv_dsp_accum_q31(const q31_t * src, uint32_t size);
 ...
 * @return Accumulate value
 */
q63_t riscv_dsp_accum_q15(const q15_t * src, uint32_t size);
 ...
 * @return Accumulate value
 */
q31_t riscv_dsp_accum_q7(const q7_t * src, uint32_t size);
 ...
 * @return Accumulate value
 */
uint32_t riscv_dsp_accum_u8(const u8_t * src, uint32_t size);
 ...
 * @return Accumulate value
 */
float16_t riscv_dsp_accum_f16(const float16_t * src, uint32_t size);
#endif
/** @} accum */
