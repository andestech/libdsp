...
/**
 * @brief instance structure of the f16 SVM linear estimator
 */
typedef struct
{
    uint32_t        numofvec;     /**< number of support vectors */
 ...
 * @return none.
 */
void riscv_dsp_svm_linear_est_f16(const riscv_dsp_svm_linear_f16_t *instance, const float16_t *src, int32_t *result);
#endif
 ...
 * @return none.
 */
void riscv_dsp_svm_sigmoid_est_f16(const riscv_dsp_svm_sigmoid_f16_t *instance, const float16_t *src, int32_t *result);
#endif
...
typedef struct
{
    ...
    const int32_t   *classes;       /**< The 2 SVM classes         */
    float16_t       gamma;        /**< Gamma factor              */
} riscv_dsp_svm_rbf_f16_t;
#endif

/**
 * @brief SVM rbf f32 prediction
 * @param[in]    instance    pointer of the instance structure
 * @param[in]    src         pointer of the input vector
 * @param[out]   result      decision value
 * @return none.
...
#if defined (__riscv_zfh)
/**
 * @brief SVM rbf f16 prediction
 * @param[in]    instance    pointer of the instance structure
 * @param[in]    src         pointer of the input vector
 * @param[out]   result      decision value
 * @return none.
 */
void riscv_dsp_svm_rbf_est_f16(const riscv_dsp_svm_rbf_f16_t *instance, const float16_t *src, int32_t *result);
#endif
...
typedef struct
{
    ...
    float16_t       coef0;        /**< Independent constant      */
    float16_t       gamma;        /**< Gamma factor              */
} riscv_dsp_svm_poly_f16_t;
#endif

/**
 * @brief SVM polynomial f32 prediction
 * @param[in]    instance    pointer of the instance structure
 * @param[in]    src         pointer of the input vector
 * @param[out]   result      decision value
 * @return none.
...
#if defined (__riscv_zfh)
/**
 * @brief SVM polynomial f16 prediction
 * @param[in]    instance    pointer of the instance structure
 * @param[in]    src         pointer of the input vector
 * @param[out]   result      decision value
 * @return none.
 */
void riscv_dsp_svm_poly_est_f16(const riscv_dsp_svm_poly_f16_t *instance, const float16_t *src, int32_t *result);
#endif
