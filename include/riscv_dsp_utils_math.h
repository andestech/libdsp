 ...
 * single-precision floating-point and Q number functions.
 *
 * For single-precision floating-point functions, there is no limitation for the input range since the inputs, whatever
 ...
 * single- and half-precision floating-point, Q31 and Q15. These functions are introduced in the subsections below.
 */
/**
 * @addtogroup cos_sine
 * @{
 ...
 *
 * This example also serves as a reference for examples of Q31, Q15 and F16 cosine/sine functions.
 *     </pre>
 */
 ...
 * @b Note:
 *
 * This function is only supported by toolchains with the HW FPU support. Also, you will need to apply the option “-mzfh” both in compiler and linker flags for applications that use this function. For details about the linking option “-mzfh”, please refer to linking section.
 */
 ...
 * functions, but you can use conversion formulas to convert them to their single-precision floating-point
 * counterparts.
 *
 * Andes DSP library supports distinct arc tangent 2 functions for single-precision floating-point, Q31 and Q15 data
 ...
 * @b Note:
 *
 * The return value is in the single-precision floating-point format and always in the range [-pi, pi]
 */
 ...
 * @b Note:
 *
 * The return value is in the f16 format and always in the range [-pi, pi]
 */
float16_t riscv_dsp_atan2_f16(float16_t y, float16_t x);
#endif
 ...
 * [-1, 1)). To convert the value to the single-precision floating-point format, apply the following formula:
 *   <pre>
...
#if defined (__riscv_zfh)
/**
 * @brief Square root of the f16 input.
 * @param[in]       src input value
 * @return Square root of the input.
 */
 ...
 */
/**
 * @brief Convert a single-precision floating-point vector to Q15.
...
/**
 * @brief Convert a single-precision floating-point vector to Q31.
 * @param[in]       src  pointer of the input vector
 * @param[out]      dst  pointer of the output vector
 * @param[in]       size number of elements in a vector
 * @return none.
...
/**
 * @brief Convert a single-precision floating-point vector to Q7.
 * @param[in]       src  pointer of the input vector
 * @param[out]      dst  pointer of the output vector
 * @param[in]       size number of elements in a vector
 * @return none.
 ...
 * @return none.
 */
void riscv_dsp_convert_f64_f32(float64_t *src, float32_t *dst, uint32_t size);
/**
 ...
 * @return none.
 */
void riscv_dsp_convert_f64_q31(float64_t *src, q31_t *dst, uint32_t size);
/**
 ...
 * @return none.
 */
void riscv_dsp_convert_f64_q15(float64_t *src, q15_t *dst, uint32_t size);
/**
 ...
 * @return none.
 */
void riscv_dsp_convert_f64_q7(float64_t *src, q7_t *dst, uint32_t size);
#if defined (__riscv_zfh)
/**
 ...
 * @return none.
 */
void riscv_dsp_convert_f64_f16(float64_t *src, float16_t *dst, uint32_t size);
#endif
 ...
 * @return none.
 */
void riscv_dsp_convert_f32_f64(float32_t *src, float64_t *dst, uint32_t size);
#if defined (__riscv_zfh)
/**
 * @brief Convert a F32 vector to F16.
 * @param[in]       src  pointer of the input vector
 * @param[out]      dst  pointer of the output vector
 * @param[in]       size number of elements in a vector
 * @return none.
 */
void riscv_dsp_convert_f32_f16(float32_t *src, float16_t *dst, uint32_t size);
#endif
 ...
 * @return none.
 */
void riscv_dsp_convert_q31_f64(q31_t *src, float64_t *dst, uint32_t size);
 ...
 * @return none.
 */
void riscv_dsp_convert_q15_f64(q15_t *src, float64_t *dst, uint32_t size);
#if defined (__riscv_zfh)
/**
 ...
 * @return none.
 */
void riscv_dsp_convert_q15_f16(q15_t *src, float16_t *dst, uint32_t size);
#endif
 ...
 * @return none.
 */
void riscv_dsp_convert_q7_f64(q7_t *src, float64_t *dst, uint32_t size);

#if defined (__riscv_zfh)
/**
 * @brief Convert a F16 vector to F64.
 * @param[in]       src  pointer of the input vector
 * @param[out]      dst  pointer of the output vector
 * @param[in]       size number of elements in a vector
 * @return none.
 */
void riscv_dsp_convert_f16_f64(float16_t *src, float64_t *dst, uint32_t size);
/**
 ...
 * @return none.
 */
void riscv_dsp_convert_f16_f32(float16_t *src, float32_t *dst, uint32_t size);
/**
...
/**
 * @brief Duplicate the f64 vector
 * @param[in]       src  pointer of the input vector
 * @param[out]      dst  pointer of the output vector
 * @param[in]       size number of elements in a vector
 * @return none.
 */
void riscv_dsp_dup_f64(float64_t *src, float64_t *dst, uint32_t size);

#if defined (__riscv_zfh)
/**
 * @brief Duplicate the f16 vector
 * @param[in]       src  pointer of the input vector
 * @param[out]      dst  pointer of the output vector
 * @param[in]       size number of elements in a vector
 * @return none.
 */
void riscv_dsp_dup_f16(float16_t *src, float16_t *dst, uint32_t size);
#endif
 ...
 * @image html set.gif ""
 *
 * Andes DSP library supports distinct set functions for the following data types: single-precision floating-point,
 ...
 */
/**
 * @brief Set the single-precision floating-point vector.
...
/**
 * @brief Set the f64 vector.
 * @param[in]       val  value to be written to the output vector
 * @param[out]      dst  pointer of the output vector
 * @param[in]       size number of elements in a vector
 * @return none.
 */
void riscv_dsp_set_f64(float64_t val, float64_t *dst, uint32_t size);

#if defined (__riscv_zfh)
/**
 * @brief Set the f16 vector.
 * @param[in]       val  value to be written to the output vector
 * @param[out]      dst  pointer of the output vector
 * @param[in]       size number of elements in a vector
 * @return none.
 */
void riscv_dsp_set_f16(float16_t val, float16_t *dst, uint32_t size);
#endif
 ...
 * @return Weighted sum value
 */
float16_t riscv_dsp_weighted_sum_f16(const float16_t *src, const float16_t *weight, uint32_t size);
#endif
/** @} weighted */
 ...
 * @return  None
 */
void riscv_dsp_barycenter_f16(const float16_t *src, const float16_t *weights, float16_t *out, uint32_t numofvec, uint32_t dimofvec);
#endif
/** @} bary */
...
/**
 * @brief Calculate exponential value of f64 vector.
 * @param[in] src input value
 * @return exponential value of the input
 */
float64_t riscv_dsp_exp_f64(float64_t src);
 ...
 *
 * Andes DSP library supports distinct sigmoid functions for single- and half-precision floating-point data types. These functions are introduced in the subsections below.
 */
/**
 * @addtogroup sigmoid
 * @{
 ...
 *
 * Andes DSP library supports distinct natural logarithmic functions for single- and half-precision floating-point data types. These functions are introduced in the subsections below.
 */
/**
 * @addtogroup log
 * @{
 */
/**
 * @brief Calculate the natural logarithm value of f32 input.
 * @param[in] src input value
...
/**
 * @brief Calculate the natural logarithm value of f64 input.
 * @param[in] src input value
 * @return natural logarithm value of the input
 */
float64_t riscv_dsp_log_f64(float64_t src);

/**
 * @brief Calculate the natural logarithm value of q15 input.
 * @param[in] src input value
 * @return natural logarithm value of the input
 */
q15_t riscv_dsp_log_q15(q15_t src);

/**
 * @brief Calculate the natural logarithm value of q31 input.
 * @param[in] src input value
 * @return natural logarithm value of the input
 */
