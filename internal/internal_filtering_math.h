...
static inline void dsp_cirwrite_f32(int32_t *buf, int32_t len,
...
static inline void dsp_cirwrite_q15(q15_t *buf, int32_t len,
...
static inline void dsp_cirwrite_q7(q7_t *buf, int32_t len,
...
static inline void dsp_cirread_f32(int32_t *buf, int32_t len,
...
static inline void dsp_cirread_q15(q15_t *buf, int32_t len,
...
static inline void dsp_cirread_q7(q7_t *buf, int32_t len,
...
static inline q63_t dsp_mul_64x32(q63_t x, q31_t y)
{
    q63_t ret;
    q31_t x_high, tmp;
    uint32_t x_low;
...
static inline uint32_t dsp_recip_q31(q31_t src, q31_t *dst)
{
    q31_t out = 0;
    uint32_t val = 0, sign = 0;

    sign = (src > 0) ? (dsp_clz(src) - 1) : (dsp_clz(-src) - 1);
    src = src << sign;
    ...
    val = 0x7FFFFFFF - val;
    out = (q31_t) dsp_truncate_q63_to_q31(((q63_t) out * val) >> 30u);
...
static inline uint32_t dsp_recip_q15(q15_t src, q15_t *dst)
{
    q15_t out = 0;
    uint32_t val = 0, sign = 0;

    sign = (src > 0) ? (dsp_clz(src) - 17) : (dsp_clz(-src) - 17);
    src = src << sign;
