...
int riscv_dsp_bilinear_interp_f32(riscv_dsp_bilinear_interp_f32_t * FUNC_RESTRICT instance,
                                  float32_t * FUNC_RESTRICT src_x, float32_t * FUNC_RESTRICT src_y, float32_t * FUNC_RESTRICT dst, uint32_t size)
{
    float32_t out;
