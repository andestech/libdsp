...
int riscv_dsp_mat_ldlt_f32(float32_t* FUNC_RESTRICT src, float32_t* FUNC_RESTRICT dstl, float32_t* FUNC_RESTRICT dstd,  uint16_t* FUNC_RESTRICT pp, uint32_t row, uint32_t col)
{
