...
/**
 * @brief Subtraction of two q15 matrices.
...
void riscv_dsp_mat_sub_q15(const q15_t * FUNC_RESTRICT src1, const q15_t * FUNC_RESTRICT src2,
                       q15_t * FUNC_RESTRICT dst, uint32_t row, uint32_t col)
{
    uint32_t size = row * col;
    riscv_dsp_sub_q15((q15_t *)src1, (q15_t *)src2, dst, size);
}
