...
int main(void)
{
    ...
    sprintf (path_buffer, "%s/golden_mult_cmplx_q31.bin", srcdir);
    ...
    riscv_dsp_cmul_q31(inputAvec, inputBvec, outputvec, numsample);
    max = dump2_q31(goldenvec, outputvec, 2 * numsample);
