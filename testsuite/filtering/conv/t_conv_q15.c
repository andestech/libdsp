...
q15_t golden12_8[] =
{
    0,    0,    25,    136,    478,    880,    1314,   660,
    1045,    2769,    -685,    3057,    1186,    -610,    1031,    594,
    323,    -49,    -133
};

q15_t golden12_3[] =
{
    0,    0,    25,    136,    479,    910,    1404,    676,
    346,    1703,    -1249,    1653,    719,    -597
};

q15_t golden7_12[] =
{
    0,    0,    25,    136,    478,    880,    1314,    364,
    1026,    1067,    973,    831,    643,    145,    51,    166,
    9,    51
};

q15_t golden12_6[] =
{
    0,    0,    25,    136,    478,    880,    1314,    658,
    986,    2492,    -1329,    2642,    986,    -1357,   1301,    340,
    -357
};

q15_t golden12_5[] =
{
    0,    0,    25,    136,    478,    880,    1312,    570,
    612,    1719,    -1522,    2447,    -47,    -353,    337,    -154
};
...
float32_t sub_conv(struCorr * instance, float32_t tmpresult[])
{
    int32_t i;
    ...
    riscv_dsp_conv_q15(inputa, len1, inputb, len2, output);
...
int main(void)
{
    ...
    {
        tmpNRMSD = sub_conv(&CorrArray[i], tmpresult);
        if (tmpNRMSD >= NRMSD)
        {
