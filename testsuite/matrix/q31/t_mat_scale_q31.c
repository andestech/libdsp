...
int main(void)
{
    ...
    sprintf (path_buffer, "%s/golden_mat_scale_q31.bin", srcdir);
    ...
    riscv_dsp_mat_scale_q31(pIn, scalf, sft, output, MATRIX_ROW, MATRIX_COL);
