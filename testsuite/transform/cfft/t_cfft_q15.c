...
int main(void)
{
    ...
    // Sine Tone case
    riscv_dsp_cfft_q15(buf, TRANSFORM_SAMPLES_LOG);
    ...
    // Random case
    riscv_dsp_cfft_q15(ran_q15_in, TRANSFORM_SAMPLES_LOG);
    ...
    // Sine Tone case
    riscv_dsp_cifft_q15(buf, TRANSFORM_SAMPLES_LOG);
