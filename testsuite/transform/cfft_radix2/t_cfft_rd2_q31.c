...
int main(void)
{
    ...
    // Sine Tone case
    riscv_dsp_cfft_rd2_q31(buf, TRANSFORM_SAMPLES_LOG);
    ...
    // Random case
    riscv_dsp_cfft_rd2_q31(ran_q31_in, TRANSFORM_SAMPLES_LOG);
    ...
    // Sine Tone case
    riscv_dsp_cifft_rd2_q31(buf, TRANSFORM_SAMPLES_LOG);
