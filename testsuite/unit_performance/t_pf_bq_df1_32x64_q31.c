...
q63_t bstq63[STATE_LEN] FUNC_ATTR_ALIGN = {0};
...
int main(void)
{
    ...
    coq31[5] = -0x8000000;
    coq31[11] = 0x8000000;
    riscv_dsp_bq_df1_32x64_q31_t bsiq31 = {bstage, bstq63, coq31, firshift};
    ...
    startPFM;
#endif
    riscv_dsp_bq_df1_32x64_q31(&bsiq31, fsrcq31, foutq31, bsize);
#ifdef PF_COUNTER
    stopPFM;
    readResult();
#endif
