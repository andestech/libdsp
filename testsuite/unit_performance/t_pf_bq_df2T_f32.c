...
float32_t bstf32[BIQUAD_DF2T_STATE_LEN] FUNC_ATTR_ALIGN = {0};
...
int main(void)
{
    ...
    bcof32[7] = 0.1;
    bcof32[11] = 0.1;
    riscv_dsp_bq_df2T_f32_t bsif32 = {bstage, bstf32, bcof32};
    float32_t *fptrf32;
    ...
    for (j = 0; j < TEST_LOOP_F32; j++)
    {
        ...
        startPFM;
#endif
        riscv_dsp_bq_df2T_f32(&bsif32, fsrcf32, foutf32, bsize);
#ifdef PF_COUNTER
        stopPFM;
        ACC_Result(&result);
#endif
