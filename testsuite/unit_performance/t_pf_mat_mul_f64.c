...
float64_t matsrcf32_2[MAT2_SIZE] FUNC_ATTR_ALIGN;
float64_t matoutf32[MAT_MUL_OUT] FUNC_ATTR_ALIGN;
int main(void)
{
    ...
    startPFM;
#endif
    riscv_dsp_mat_mul_f64(matsrcf32_1, matsrcf32_2, matoutf32, ROW, COL, COL2);
#ifdef PF_COUNTER
    stopPFM;
    readResult();
#endif
