...
int32_t riscv_dsp_cfft_rd2_f64(float64_t *src, uint32_t m)
{
    uint32_t j, k, n2, ie, ia;
    float64_t c, s, xa, xb, ya, yb;
    float64_t *ptrs, *ptre;
    float64_t xt, yt;
    uint32_t n;
    ...
    while (ptrs != ptre)
    {
        ...
        ia++;
#if FFT_LOGN > RES_LOGN
        GET_COS_SIN_VALUES(ia, c, s, p, f64);
#else
        GET_COS_SIN_VALUES(ia, c, s, m, f64);
#endif /* FFT_LOGN > RES_LOGN */
    ...
    return riscv_dsp_bit_reversal_f64 (src, m);
}
...
int32_t riscv_dsp_cifft_rd2_f64(float64_t *src, uint32_t m)
{
    uint32_t j, k, n2, ie, ia;
    float64_t c, s, xa, ya, xb, yb;
    float64_t *ptrs, *ptre;
    float64_t xt, yt;
    uint32_t n;
     ...
     * execute onece. also, cos(0) == 1 and sin(0) == 0. */
    ptrs = &src[0];
    float64_t pp = riscv_dsp_recip_table_f64[m - 1];
    ptre = &src[2 * n];
    while (ptrs != ptre)
    {
        xa = ptrs[0];
...
int32_t riscv_dsp_cfft_8pt_f64(float64_t *src, uint32_t m)
{
    (void) m;
    float64_t tmp_cal_float_r[8];
    float64_t tmp_cal_float_i[8];
    float64_t TW_81 = (float64_t)0.70710678118654752440;
    float64_t tmp_cpx_r[16];
    float64_t tmp_cpx_i[16];
...
int32_t riscv_dsp_cfft_4pt_f64(float64_t *src, uint32_t m)
{
    // used for 3pts rfft
    (void) m;
    float64_t tmp_cal_float_r[4];
    float64_t tmp_cal_float_i[4];
...
int32_t riscv_dsp_cifft_8pt_f64(float64_t *src, uint32_t m)
{
    (void) m;
    float64_t tmp_cal_float_r[8];
    float64_t tmp_cal_float_i[8];
    ...
    float64_t tmp_cpx_r[16];
    float64_t tmp_cpx_i[16];
    float64_t inv_factor = (float64_t)1.0f/ 8.0f ;
...
int32_t riscv_dsp_cifft_4pt_f64(float64_t *src, uint32_t m)
{
    // used for 3pts rfft
    (void) m;
    float64_t inv_factor = 1.0f / 4.0f;
    float64_t tmp_cal_float_r[4];
    float64_t tmp_cal_float_i[4];
