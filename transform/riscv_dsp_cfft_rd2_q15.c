...
int32_t riscv_dsp_cfft_rd2_q15_noscale(q15_t *src, uint32_t m)
{
    ...
    dump_data_q15(src, n * 2, "no scale input data");

    /* a = xa + ya * i and b = xb + yb * i */
    // may not overflow, the input has been scaled down
    xa = ptrs[0] ;
    ya = ptrs[1] ;
    xb = ptre[0] ;
    yb = ptre[1] ;
    ...
    dump_data_q15(src, n * 2, "no scale before 1st stage");
    ...
    while (ptrs != ptre)
    {
        ...
        /* a = xa + ya * i and b = xb + yb * i */
        ptr = ptrs + n;
        // may not overflow, the data has been scaled
        xa = ptrs[0] ;
        ya = ptrs[1] ;
        xb = ptr[0]  ;
        yb = ptr[1]  ;
    ...
    dump_data_q15(src, n * 2, "no scale after 1st stage");
    ...
    while (k)
    {
        ...
        dump_data_q15(src, n * 2, "\t no scale stage 2.1");
    ...
    dump_data_q15(src, n * 2, "no scale after 2nd stage");
    ...
    dump_data_q15(src, n * 2, "no scale after 3rd stage");

    /* Bit reversal permutation */
    riscv_dsp_bit_reversal_q15(src, m);

    dump_data_q15(src, n * 2, "no scale after bit rev");
    return 0;
}

int32_t riscv_dsp_cfft_8pt_q15(q15_t *src, uint32_t m)
{
    ...
    // tmp_cpx_r[0-7] in q13
    // tmp_cpx_i[0-7] in q13
    ...
    tmp_cpx_r[3] = (q15_t) (((q31_t)(tmp_cal_r[3] + tmp_cal_i[3]) * (q31_t)TW_81 ) >> 15 );
    tmp_cpx_i[3] = (q15_t) (((q31_t)(tmp_cal_i[3] - tmp_cal_r[3]) * (q31_t)TW_81 ) >> 15 );
    tmp_cpx_r[7] = (q15_t) (((q31_t)(tmp_cal_r[7] - tmp_cal_i[7]) * (q31_t)TW_81 ) >> 15 );
    tmp_cpx_i[7] = (q15_t) (((q31_t)(tmp_cal_i[7] + tmp_cal_r[7]) * (q31_t)TW_81 ) >> 15 );

    // tmp_cpx_r[8-15] in q12
    // tmp_cpx_i[8-15] in q12
...
int32_t riscv_dsp_cfft_4pt_q15(q15_t *src, uint32_t m)
{
    // used for 3pts rfft
    (void) m;
    q15_t tmp_cal_r[4];
    ...
    // tmp_cal_r[0-3] in q13
    // tmp_cal_i[0-3] in q13
    // output in q12
...
int32_t riscv_dsp_cifft_8pt_q15(q15_t *src, uint32_t m)
{
    (void) m;
    q15_t tmp_cal_r[8];
    q15_t tmp_cal_i[8];
    ...
    tmp_s_r = ((q31_t)tmp_cpx_r[8] + (q31_t)tmp_cpx_r[12]) << 1;
    tmp_s_i = ((q31_t)tmp_cpx_i[8] + (q31_t)tmp_cpx_i[12]) << 1;
    //src[0]  = (tmp_cpx_r[8] + tmp_cpx_r[12]);
    //src[1]  = (tmp_cpx_i[8] + tmp_cpx_i[12]);
    src[0] = (q15_t)NDS_ISA_SATS(tmp_s_r, 16);
    src[1] = (q15_t)NDS_ISA_SATS(tmp_s_i, 16);    

    tmp_s_r = ((q31_t)tmp_cpx_r[9] + (q31_t)tmp_cpx_r[13]) << 1;
    tmp_s_i = ((q31_t)tmp_cpx_i[9] + (q31_t)tmp_cpx_i[13]) << 1;
    //src[2]  = (tmp_cpx_r[9] + tmp_cpx_r[13]);
    //src[3]  = (tmp_cpx_i[9] + tmp_cpx_i[13]);
    src[2] = (q15_t)NDS_ISA_SATS(tmp_s_r, 16);
    src[3] = (q15_t)NDS_ISA_SATS(tmp_s_i, 16);

    tmp_s_r = ((q31_t)tmp_cpx_r[10] - (q31_t)tmp_cpx_i[14]) << 1;
    tmp_s_i = ((q31_t)tmp_cpx_i[10] + (q31_t)tmp_cpx_r[14]) << 1;
    //src[4]  = (tmp_cpx_r[10] - tmp_cpx_i[14]);
    //src[5]  = (tmp_cpx_i[10] + tmp_cpx_r[14]);
    src[4] = (q15_t)NDS_ISA_SATS(tmp_s_r, 16);
    src[5] = (q15_t)NDS_ISA_SATS(tmp_s_i, 16);

    tmp_s_r = ((q31_t)tmp_cpx_r[11] - (q31_t)tmp_cpx_i[15]) << 1;
    tmp_s_i = ((q31_t)tmp_cpx_i[11] + (q31_t)tmp_cpx_r[15]) << 1;
    //src[6]  = (tmp_cpx_r[11] - tmp_cpx_i[15]);
    //src[7]  = (tmp_cpx_i[11] + tmp_cpx_r[15]);
    src[6] = (q15_t)NDS_ISA_SATS(tmp_s_r, 16);
    src[7] = (q15_t)NDS_ISA_SATS(tmp_s_i, 16);

    tmp_s_r = ((q31_t)tmp_cpx_r[8] - (q31_t)tmp_cpx_r[12]) << 1;
    tmp_s_i = ((q31_t)tmp_cpx_i[8] - (q31_t)tmp_cpx_i[12]) << 1;
    //src[8]  = (tmp_cpx_r[8] - tmp_cpx_r[12]);
    //src[9]  = (tmp_cpx_i[8] - tmp_cpx_i[12]);
    src[8] = (q15_t)NDS_ISA_SATS(tmp_s_r, 16);
    src[9] = (q15_t)NDS_ISA_SATS(tmp_s_i, 16);

    tmp_s_r = ((q31_t)tmp_cpx_r[9] - (q31_t)tmp_cpx_r[13]) << 1;
    tmp_s_i = ((q31_t)tmp_cpx_i[9] - (q31_t)tmp_cpx_i[13]) << 1;
    //src[10] = (tmp_cpx_r[9] - tmp_cpx_r[13]);
    //src[11] = (tmp_cpx_i[9] - tmp_cpx_i[13]);
    src[10] = (q15_t)NDS_ISA_SATS(tmp_s_r, 16);
    src[11] = (q15_t)NDS_ISA_SATS(tmp_s_i, 16);
  
    tmp_s_r = ((q31_t)tmp_cpx_r[10] + (q31_t)tmp_cpx_i[14]) << 1;
    tmp_s_i = ((q31_t)tmp_cpx_i[10] - (q31_t)tmp_cpx_r[14]) << 1;
    //src[12] = (tmp_cpx_r[10] + tmp_cpx_i[14]);
    //src[13] = (tmp_cpx_i[10] - tmp_cpx_r[14]);
    src[12] = (q15_t)NDS_ISA_SATS(tmp_s_r, 16);
    src[13] = (q15_t)NDS_ISA_SATS(tmp_s_i, 16);

    tmp_s_r = ((q31_t)tmp_cpx_r[11] + (q31_t)tmp_cpx_i[15]) << 1;
    tmp_s_i = ((q31_t)tmp_cpx_i[11] - (q31_t)tmp_cpx_r[15]) << 1;
    //src[14] = (tmp_cpx_r[11] + tmp_cpx_i[15]);
    //src[15] = (tmp_cpx_i[11] - tmp_cpx_r[15]);
    src[14] = (q15_t)NDS_ISA_SATS(tmp_s_r, 16);
    src[15] = (q15_t)NDS_ISA_SATS(tmp_s_i, 16);
    return 0;
}

int32_t riscv_dsp_cifft_4pt_q15(q15_t *src, uint32_t m)
{
    // used for 3pts rfft
    (void) m;
    ...
    tmp_s_r = ((q31_t)tmp_cal_r[0] + (q31_t)tmp_cal_r[2]) << 1;
    tmp_s_i = ((q31_t)tmp_cal_i[0] + (q31_t)tmp_cal_i[2]) << 1;
    //src[0] = (tmp_cal_r[0] + tmp_cal_r[2]);
    //src[1] = (tmp_cal_i[0] + tmp_cal_i[2]);
    src[0] = (q15_t)NDS_ISA_SATS(tmp_s_r, 16);
    src[1] = (q15_t)NDS_ISA_SATS(tmp_s_i, 16);

    tmp_s_r = ((q31_t)tmp_cal_r[1] - (q31_t)tmp_cal_i[3]) << 1;
    tmp_s_i = ((q31_t)tmp_cal_i[1] + (q31_t)tmp_cal_r[3]) << 1;
