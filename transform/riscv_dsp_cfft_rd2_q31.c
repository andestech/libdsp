...
int32_t riscv_dsp_cifft_rd2_q31(q31_t *src, uint32_t m)
{
    ...
    while (ptrs != ptre)
    {
        ...
        yb = ptrs[3];
        q31_t tmp_r, tmp_i;
        tmp_r = NDS_ISA_KADDW(xa,xb);
        tmp_i = NDS_ISA_KADDW(ya,yb);
        ptrs[0] = NDS_ISA_KSLRAW(tmp_r, 1);
        ptrs[1] = -NDS_ISA_KSLRAW(tmp_i, 1);
        tmp_r = NDS_ISA_KSUBW(xa,xb);
        tmp_i = NDS_ISA_KSUBW(yb,ya);
        ptrs[2] = NDS_ISA_KSLRAW(tmp_r, 1);
        ptrs[3] = NDS_ISA_KSLRAW(tmp_i, 1);
        ...
        tmp_r = NDS_ISA_KADDW(xa,xb);
        tmp_i = NDS_ISA_KADDW(ya,yb);
        ptrs[4] = NDS_ISA_KSLRAW(tmp_r, 1);
        ptrs[5] = -NDS_ISA_KSLRAW(tmp_i, 1);
        tmp_r = NDS_ISA_KSUBW(xa,xb);
        tmp_i = NDS_ISA_KSUBW(yb,ya);
        ptrs[6] = NDS_ISA_KSLRAW(tmp_r, 1);
        ptrs[7] = NDS_ISA_KSLRAW(tmp_i, 1);
