...
int32_t riscv_dsp_cifft_rd4_q15(q15_t *src, uint32_t m)
{
    ...
    while (ptrs != ptre)
    {
        ...
        tmp_s_r = ((q31_t) xc + (q31_t) yd) << 1 ;
        ptrs[4] = (q15_t) NDS_ISA_SATS(tmp_s_r, 16);

        tmp_s_i = -(((q31_t) yc - (q31_t)xd) << 1);
...
int32_t riscv_dsp_cfft_rd4_q15_noscale(q15_t *src, uint32_t m)
{
    register unsigned int j, k, n2, ie, ia1, ia2, ia3;
    q15_t c1, c2, c3, s1, s2, s3;
    q15_t *ptrs, *ptre, *ptr1, *ptr2, *ptr3;
    ...
    for (k = (m >> 1) - 2; 0 != k; k--)
    {
        ...
        dump_data_q15(src, n * 2, "\tno scale begin 2nd stage");
