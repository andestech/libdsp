...
/**
 * @defgroup utilsdup Duplicate vector
 *
 * Duplicate the floating-point vector
 *
 * <pre>
 *    while (size > 0)
 *    {
...
void riscv_dsp_dup_f32(float32_t * FUNC_RESTRICT src, float32_t * FUNC_RESTRICT dst, uint32_t size)
{
    while (size != 0u)
    {
        /* y = |x| */
