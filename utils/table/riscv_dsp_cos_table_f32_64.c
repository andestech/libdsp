 ...
 *   riscv_dsp_cos_table_f32_64[k + 2] = cos(2 * PI * k / 64)
 * #else
 *   riscv_dsp_cos_table_f32_64[k] = cos(2 * PI * k / 64)
 * #endif
 * where 0 <= k <= 16.
 **/

#ifdef HERMITE_INTERPOLATION
const float riscv_dsp_cos_table_f32_64[21] =
{
    0.980785280403230, 0.995184726672197,
    1.000000000000000, 0.995184726672197, 0.980785280403230, 0.956940335732209,
#else
const float riscv_dsp_cos_table_f32_64[17] =
{
    1.000000000000000, 0.995184726672197, 0.980785280403230, 0.956940335732209,
#endif
...
const float riscv_dsp_cos_table_f32_linear_64[17] =
{
    1.000000000000000, 0.995184726672197, 0.980785280403230, 0.956940335732209,
    0.923879532511287, 0.881921264348355, 0.831469612302545, 0.773010453362737,
    0.707106781186548, 0.634393284163645, 0.555570233019602, 0.471396736825998,
 ...
 *   riscv_dsp_cos_recip_table_f32_64[k] = 1 / (2 * cos(2 * PI * k / 64))  *
 *   where 0 <= k < 16.                                                   *
 ***************************************************************************/

const float riscv_dsp_cos_recip_table_f32_64[16] =
{
