...
void riscv_dsp_win_blackman_harris_92db_f32(float32_t * FUNC_RESTRICT dst, uint32_t size)
{
    dsp_weighted_sum_of_cos_3(dst, size, 0.35875f, -0.48829f, 0.14128f, -0.01168f);
}
