...
void riscv_dsp_win_hft169d_f32(float32_t * FUNC_RESTRICT dst, uint32_t size)
{
    dsp_weighted_sum_of_cos_7(dst, size, 1.0f, -1.97441843f, 1.65409889f, -0.95788187f, 0.33673420f, -0.06364622f, 0.00521942f, -0.00010599f);
}
