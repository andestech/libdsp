...
void riscv_dsp_win_hft169d_f64(float64_t * FUNC_RESTRICT dst, uint32_t size)
{
    dsp_weighted_sum_of_cos_7(dst, size, 1.0, -1.97441843, 1.65409889, -0.95788187, 0.33673420, -0.06364622, 0.00521942, -0.00010599f);
}
