...
void riscv_dsp_win_nuttall4c_f32(float32_t * FUNC_RESTRICT dst, uint32_t size)
{
    dsp_weighted_sum_of_cos_3(dst, size, 0.3635819f, -0.4891775f, 0.1365995f, -0.0106411f);
}
